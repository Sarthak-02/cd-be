...
export const LessonPlanCreateSchema = {
  ...
  body: {
    ...
    properties: {
      ...
      description: {
        type: "string",
        description: "Optional lesson / chapter notes (longer text)",
      },
      ...
      subject: {
        type: "string",
        minLength: 1,
        description: "Subject label or name (free text, not tied to Subject table)",
      },
...
export const LessonPlanListSchema = {
  ...
  querystring: {
    ...
    properties: {
      ...
      subject: { type: "string", description: "Filter by exact subject string" },
      class_id: { type: "string" },
...
export const LessonPlanUpdateSchema = {
  ...
  body: {
    ...
    properties: {
      ...
      status: { type: "string", enum: lessonPlanStatusEnum },
      subject: { type: ["string", "null"], description: "Set to null or empty to clear" },
      class_id: { type: "string" },
